...
import casinoGamesRoutes from "./routes/casinoGames.js";
...
// Casino jeux (slots/gratte/hi-lo) — autoritatif serveur, token requis
app.use("/api/casino",        verifyToken, casinoGamesRoutes);
