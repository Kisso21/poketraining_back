...
const ITEM_REWARDS = {
  ...
  "unlock-level-3":        { resetball: 1 },
  "unlock-level-4":        { potion: 1 },
  "unlock-level-5":        { hyperball: 1 },
  "unlock-level-6":        { lootbox: 1 },
  "unlock-level-7":        { hyperball: 1 },
  "unlock-pokeclick":      { potion: 1 },
  "unlock-casino":         { lootbox: 1 },
  "unlock-safari":         { sablier: 1 },
  "unlock-dessin":         { lootbox: 1 },
  "unlock-memory":         { resetball: 2 },
  "unlock-radar":          { lootbox: 1 },
  "unlock-stop":           { resetball: 2, lootbox: 1 },
  ...
  "safari-volcan":         { resetball: 1 },
  "safari-montagne":       { potion: 1 },
  "safari-marais":         { potion: 1 },
  "safari-tempete":        { hyperball: 1 },
  "safari-ciel":           { resetball: 1 },
  // Pokédex — familles existantes
  "pokedex-starters":      { resetball: 1 },
  "pokedex-fossiles":      { sablier: 1 },
  ...
  // Pokédex — nouvelles familles
  "pokedex-bulba-line":    { resetball: 1 },
  "pokedex-char-line":     { resetball: 1 },
  "pokedex-squirtle-line": { resetball: 1 },
  "pokedex-pikachu-line":  { potion: 1 },
  "pokedex-nido-lines":    { potion: 1 },
  "pokedex-ghost-line":    { lootbox: 1 },
  "pokedex-machamp-line":  { sablier: 1 },
  "pokedex-abra-line":     { potion: 1 },
  ...
  "level-40":              { lootbox: 2 },
  "level-50":              { goldappat: 1 },
  "level-60":              { lootbox: 2 },
  "level-70":              { lootbox: 2 },
  "level-75":              { sablier: 1 },
  "level-80":              { lootbox: 2, ticketsafari: 1 },
  "level-90":              { lootbox: 2, ticketsafari: 1 },
  "level-100":             { goldappat: 1 },
  "level-150":             { goldappat: 1, lootbox: 2, ticketsafari: 1 },
  "level-200":             { goldappat: 2, lootbox: 3, ticketsafari: 1 },
  // Pokédex — compteurs
  "pokedex-normal-25":     { pokeball: 2 },
  "pokedex-normal-75":     { resetball: 1 },
  "pokedex-normal-125":    { hyperball: 1 },
  "pokedex-normal-151":    { goldappat: 1 },
  ...
  "shiny-col-50":          { lootbox: 2, ticketsafari: 1 },
  "shiny-col-75":          { charmeeclaire: 1 },
  // ── Gen 2 ────────────────────────────────────────────────────────
  ...
  "pokedex-pichu-line":       { potion: 1 },    "pokedex-togepi-line":      { sablier: 1 },
  ...
  "pokedex-chiens-leg":       { lootbox: 1 },   "pokedex-lugia":            { lootbox: 1 },
  "pokedex-ho-oh":            { lootbox: 1 },   "pokedex-celebi":           { lootbox: 2, ticketsafari: 1 },
  "pokedex-gen2-legendaires": { lootbox: 2, ticketsafari: 1 },   "pokedex-normal-200":       { lootbox: 1 },
  "pokedex-normal-251":       { goldappat: 1 }, "pokedex-roigada-line":     { superball: 1 },
  ...
  "pokedex-normal-175":       { lootbox: 1 },   "pokedex-total-300":        { lootbox: 1, ticketsafari: 1 },
  "pokedex-total-500":        { goldappat: 1 }, "pokedex-ditto":            { potion: 1 },
  "pokedex-fighting-gen1":    { lootbox: 1 },   "pokedex-eevee-complete":   { lootbox: 1 },
  "shiny-meganium":           { lootbox: 1 },   "shiny-typhlosion":         { lootbox: 1 },
  "shiny-aligatueur":         { lootbox: 1 },   "shiny-lugia":              { lootbox: 2, ticketsafari: 1 },
  "shiny-ho-oh":              { lootbox: 1 },   "shiny-celebi":             { lootbox: 1 },
  "shiny-chien-leg":          { lootbox: 1 },   "shiny-tyranocif":          { lootbox: 1 },
  "shiny-evoli-gen2":         { lootbox: 1 },   "shiny-missingno":          { charmeeclaire: 1 },
  // ── 40 nouveaux succès Gen 2 ─────────────────────────────────────────
  ...
  "pokedex-gen2-combat-collect":   { superball: 1 }, "pokedex-gen2-fee-collect":      { potion: 1 },
  "pokedex-gen2-psy-collect":      { lootbox: 1 },   "pokedex-gen2-sol-collect":      { sablier: 1 },
  ...
  "pokedex-gen2-mystere":          { lootbox: 1 },   "pokedex-johto-50":              { sablier: 1 },
  "pokedex-johto-75":              { lootbox: 1 },   "pokedex-johto-full":            { goldappat: 1 },
  "shiny-scarhino":                { hyperball: 1 },  "shiny-cizayox":                 { hyperball: 1 },
  "shiny-leuphorie":               { lootbox: 1 },   "shiny-togetic":                 { hyperball: 1 },
  "shiny-zarbi":                   { lootbox: 1 },   "shiny-hyporoi":                 { lootbox: 1 },
  "shiny-donphan":                 { hyperball: 1 },  "shiny-corsola":                 { hyperball: 1 },
  "shiny-snubbull-granbull":       { superball: 1 },  "shiny-col-100":                 { charmeeclaire: 1 },
  "shiny-gen2-starters-all":       { lootbox: 2 },   "shiny-gen2-legendary-all":      { charmeeclaire: 1 },
  "shiny-dex-251":                 { charmeeclaire: 3, lootbox: 3, ticketsafari: 1 },
  // ── Déverrouillage Gen 3 & 4 ─────────────────────────────────────────────
  "unlock-gen3-4": { goldappat: 1, lootbox: 2 },
  // ── Boss final (tous les badges) ─────────────────────────────────────────
  "final-boss": { lootbox: 3, ticketsafari: 1 },
  // ── Objets Gen 3 ──
  "g3-arcko-line": { superball: 1, potion: 1 },
  "g3-poussifeu-line": { superball: 1, sablier: 1 },
  "g3-gobou-line": { superball: 1, potion: 1 },
  "g3-medhyena-line": { superball: 1 },
  "g3-zigzaton-line": { superball: 1 },
  "g3-chenipotte-line": { superball: 1, sablier: 1 },
  "g3-blindalys-line": { superball: 1 },
  "g3-nenupiot-line": { superball: 1, potion: 1 },
  "g3-grainipiot-line": { superball: 1, sablier: 1 },
  "g3-nirondelle-line": { superball: 1 },
  "g3-goelise-line": { superball: 1 },
  "g3-tarsal-line": { superball: 1, potion: 1 },
  "g3-arakdo-line": { superball: 1 },
  "g3-balignon-line": { superball: 1 },
  "g3-parecool-line": { superball: 1, sablier: 1 },
  "g3-ningale-line": { superball: 1, potion: 1 },
  "g3-chuchmur-line": { superball: 1, sablier: 1 },
  "g3-makuhita-line": { superball: 1 },
  "g3-skitty-line": { superball: 1 },
  "g3-galekid-line": { superball: 1, potion: 1 },
  ...
  "g3-barpau-line": { superball: 1, sablier: 1 },
  "g3-polichombr-line": { superball: 1 },
  "g3-skelenox-line": { superball: 1 },
  "g3-obalie-line": { superball: 1, potion: 1 },
  "g3-stalgamin-line": { superball: 1 },
  "g3-coquiperl-line": { superball: 1, sablier: 1 },
  "g3-lilia-line": { superball: 1, potion: 1 },
  "g3-anorith-line": { superball: 1, sablier: 1 },
  "g3-draby-line": { hyperball: 2, potion: 1 },
  "g3-terhal-line": { hyperball: 2, sablier: 1 },
  "g3-absol": { superball: 1 },
  "g3-relicanth": { superball: 1 },
  "g3-zangoose-seviper": { superball: 1, potion: 1 },
  "g3-lune-soleil": { superball: 1, sablier: 1 },
  "g3-plus-minus": { superball: 1, potion: 1 },
  "g3-tenefix-mysdibule": { superball: 1, sablier: 1 },
  "g3-regirock": { lootbox: 1, hyperball: 1 },
  "g3-regice": { lootbox: 1, hyperball: 1 },
  "g3-registeel": { lootbox: 1, hyperball: 1 },
  "g3-regis": { lootbox: 1, resetball: 1 },
  "g3-latias": { lootbox: 1, hyperball: 1 },
  "g3-latios": { lootbox: 1, hyperball: 1 },
  "g3-eon": { lootbox: 1, sablier: 1 },
  "g3-kyogre": { lootbox: 1, hyperball: 1 },
  "g3-groudon": { lootbox: 1, hyperball: 1 },
  "g3-rayquaza": { lootbox: 1, hyperball: 1 },
  "g3-weather-trio": { lootbox: 1, resetball: 1 },
  "g3-jirachi": { lootbox: 1, potion: 1 },
  "g3-deoxys": { lootbox: 1, sablier: 1 },
  "g3-all-legends": { goldappat: 1, lootbox: 2, ticketsafari: 1 },
  "g3-count-25": { superball: 2, potion: 1 },
  "g3-count-50": { hyperball: 2, sablier: 1 },
  "g3-count-75": { lootbox: 1, hyperball: 2 },
  "g3-count-100": { lootbox: 1, sablier: 1, hyperball: 2 },
  "g3-count-full": { goldappat: 1, lootbox: 2, ticketsafari: 1 },
  "g3-shiny-starters": { lootbox: 1, potion: 1 },
  "g3-shiny-gardevoir": { lootbox: 1, sablier: 1 },
  "g3-shiny-metalosse": { lootbox: 1, potion: 1 },
  "g3-shiny-drattak": { lootbox: 1, sablier: 1 },
  "g3-shiny-rayquaza": { lootbox: 1, potion: 1 },
  "g3-shiny-regis": { charmeeclaire: 1, lootbox: 2 },
  "g3-shiny-jungko": { lootbox: 1, sablier: 1 },
  "g3-shiny-bragegali": { lootbox: 1, potion: 1 },
  "g3-shiny-laggron": { lootbox: 1, sablier: 1 },
  "g3-shiny-ludicolo": { lootbox: 1, potion: 1 },
  "g3-shiny-tengalice": { lootbox: 1, sablier: 1 },
  "g3-shiny-monaflemit": { lootbox: 1, potion: 1 },
  "g3-shiny-brouhabam": { lootbox: 1, sablier: 1 },
  "g3-shiny-libegon": { lootbox: 1, potion: 1 },
  "g3-shiny-altaria": { lootbox: 1, sablier: 1 },
  "g3-shiny-milobellus": { lootbox: 1, potion: 1 },
  "g3-shiny-absol": { lootbox: 1, sablier: 1 },
  "g3-shiny-kaimorse": { lootbox: 1, potion: 1 },
  "g3-shiny-sharpedo": { lootbox: 1, sablier: 1 },
  "g3-shiny-camerupt": { lootbox: 1, potion: 1 },
  "g3-shiny-branette": { lootbox: 1, sablier: 1 },
  "g3-shiny-teraclope": { lootbox: 1, potion: 1 },
  "g3-shiny-regirock": { lootbox: 1, hyperball: 2 },
  "g3-shiny-regice": { lootbox: 1, hyperball: 2 },
  "g3-shiny-registeel": { lootbox: 1, hyperball: 2 },
  "g3-shiny-latias": { lootbox: 1, hyperball: 2 },
  "g3-shiny-latios": { lootbox: 1, hyperball: 2 },
  "g3-shiny-eon": { lootbox: 1, sablier: 1 },
  "g3-shiny-kyogre": { lootbox: 1, hyperball: 2 },
  "g3-shiny-groudon": { lootbox: 1, hyperball: 2 },
  "g3-shiny-jirachi": { lootbox: 1, potion: 1 },
  // ── Objets Gen 4 ──
  "g4-tortipouss-line": { superball: 1, sablier: 1 },
  ...
  "g4-arceus": { goldappat: 1, lootbox: 2 },
  "g4-all-legends": { goldappat: 1, lootbox: 2, ticketsafari: 1 },
  ...
  "g4-shiny-giratina": { lootbox: 1, superbonbon: 1 },
  "g4-shiny-lake-trio": { charmeeclaire: 1, lootbox: 2 },
  ...
  "g4-shiny-crehelf": { lootbox: 1, hyperball: 2 },
  "g4-shiny-crefollet": { lootbox: 1, hyperball: 2 },
  "g4-shiny-crefadet": { lootbox: 1, hyperball: 2 },
  "g4-shiny-dialga": { lootbox: 1, hyperball: 2 },
  "g4-shiny-palkia": { lootbox: 1, hyperball: 2 },
  "g4-shiny-darkrai": { lootbox: 1, superbonbon: 1 },
  "g4-shiny-arceus": { charmeeclaire: 1, lootbox: 1 },
};
...
router.post("/claim", async (req, res) => {
  ...
  try {
    ...
    const VALID_ITEMS = new Set(["pokeball","superball","hyperball","masterball","resetball","superbonbon","potion","lootbox","sablier","goldappat","charmeeclaire","ticketsafari"]);
